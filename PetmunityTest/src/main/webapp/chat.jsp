...
<body>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="profileUpdate.jsp">회원 프로필 수정</a></li>
    ...
    <div class="container bootstrap snippet">
        <div class="row">
            <div class="col-xs-12" style="border-color:rgb(252, 186, 44);">
                <div class="portlet portlet-default" style="border-color:rgb(252, 186, 44);">
                    <div class="portlet-heading" style="background:rgb(252, 186, 44);">
