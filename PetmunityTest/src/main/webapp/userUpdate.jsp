            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li class="active"><a href="userUpdate.jsp">마이페이지</a></li>
            ...
            <table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="2"><input class="form-control" id="userArea" type="text" name="userArea" maxlength="20" placeholder="지역을 입력하세요." value="<%= user.getUserArea() %>"></td>
                    </tr>
                    <tr>
